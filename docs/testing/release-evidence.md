...
| Consolidated manual/API pass | `docs/public-manual-qa` / `2026-08-28` | Partial | 14 critical tests executed: 11 Pass, 1 Pass with note, 2 Partial; exact observations are in the combined guide |
